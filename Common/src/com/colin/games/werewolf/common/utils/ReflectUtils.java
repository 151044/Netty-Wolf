...
public class ReflectUtils {
    ...
    /**
     * Loads a list of subclasses of the given class from the given directory, with a list of class/package names to ignore.
     * @param p The path of the directory to check
     * @param superclass The superclass to load classes for
     * @param toIgnore The list of class/ package names to not load classes for if the class found starts with something in this list.
     * @param <T> The type of the class loaded.
     * @return A set of of classes loaded
     * @throws MalformedURLException If the path given is malformed
    ...
    /**
     * Returns a list of concrete loaded subclasses from the given directors containing JAR files, with the specified superclass and a blacklist feature.
     * @param p The path to load classes from
     * @param superclass The supertype to load; the type of the superclass
     * @param toIgnore The list of classes to blacklist with a startsWith() check
     * @param <T> The type of the superclass
